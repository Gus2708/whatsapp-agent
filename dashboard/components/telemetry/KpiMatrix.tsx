  ...
  return (
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3.5 mb-1 sm:mb-2 flex-shrink-0 p-0.5 sm:p-1">
      ...
      <CrosshairCard className="p-2.5 sm:p-3.5 bg-[#0d0d0d]">
        <div className="flex justify-between items-center font-mono text-[10px] sm:text-[10.5px] uppercase text-smoke mb-1">
        ...
        <div className="font-mono text-[10px] text-pulse-green mt-0.5 truncate">
          80.6% Res. Autónoma
        </div>
      </CrosshairCard>
